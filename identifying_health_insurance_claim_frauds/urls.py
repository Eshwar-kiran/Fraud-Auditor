...
urlpatterns = [
    ...
    re_path(r'^Predict_Health_Insurance_Claim_Fraud/$', remoteuser.Predict_Health_Insurance_Claim_Fraud, name="Predict_Health_Insurance_Claim_Fraud"),
    ...
    re_path(r'^View_Predicted_Health_Insurance_Claim_Fraud_Type_Ratio/$', serviceprovider.View_Predicted_Health_Insurance_Claim_Fraud_Type_Ratio, name="View_Predicted_Health_Insurance_Claim_Fraud_Type_Ratio"),
    re_path(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    re_path(r'^View_Predicted_Health_Insurance_Claim_Fraud_Type/$', serviceprovider.View_Predicted_Health_Insurance_Claim_Fraud_Type, name="View_Predicted_Health_Insurance_Claim_Fraud_Type"),
